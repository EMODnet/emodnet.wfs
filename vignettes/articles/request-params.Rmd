...
#> Geodetic CRS:  WGS 84
#>        gml_id             name   id status medium operator size_in length_m year from_loc to_loc country_co country
#> 1 pipelines.1 Gasoducto Magreb <NA> Active   <NA>     <NA>    <NA> 15467.17 <NA>     <NA>   <NA>         ES   Spain
#>   notes                       the_geom
#> 1  <NA> MULTILINESTRING ((-5.87186 ...
```
