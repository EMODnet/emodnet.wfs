...
layer_attribute_inspect(wfs, layer = "mediseh_posidonia_nodata", attribute = "km")
```
...
```{r}
bbox_filter <- emodnet_get_layers(service = "geology_seabed_substrate_maps",
                                  layers = "seabed_substrate_1m",
                                  cql_filter = "BBOX(geom, 3526324, 3526330, 1522239, 1522300)",
                                  reduce_layers = TRUE ) 
```
...
sf::st_crs(pr_sf) <- 3034


plot(pr_sf["folk_7cl_txt"])
```
