structure(list(url = "https://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_cymodocea_pnt&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Thu, 01 Sep 2022 11:39:25 GMT"), class = c("insensitive", 
    ...
    date = structure(1662032365, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 0.016896, 
    connect = 0.024832, pretransfer = 0.087786, starttransfer = 0.873421, 
    total = 0.873713)), class = "response")
