structure(list(url = "https://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_cor_abs_pnt&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Fri, 07 Oct 2022 13:24:11 GMT"), class = c("insensitive", 
    ...
    date = structure(1665149051, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 0.014862, 
    connect = 0.040381, pretransfer = 0.085999, starttransfer = 0.115462, 
    total = 0.115727)), class = "response")
