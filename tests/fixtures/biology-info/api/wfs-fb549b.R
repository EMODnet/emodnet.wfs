structure(list(url = "https://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_cor_abs_pnt&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Fri, 14 Oct 2022 09:13:56 GMT"), class = c("insensitive", 
    ...
    date = structure(1665738836, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 0.016605, 
    connect = 0.043062, pretransfer = 0.077134, starttransfer = 0.108647, 
    total = 0.108852)), class = "response")
