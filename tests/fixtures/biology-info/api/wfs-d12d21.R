structure(list(url = "https://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_zostera_m_pnt&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Tue, 26 Apr 2022 18:33:20 GMT"), class = c("insensitive", 
    ...
    date = structure(1650998000, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.1e-05, 
    connect = 2.1e-05, pretransfer = 7.4e-05, starttransfer = 0.040758, 
    total = 0.040841)), class = "response")
