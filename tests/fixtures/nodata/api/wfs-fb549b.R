structure(list(url = "https://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_cor_abs_pnt&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Fri, 14 Oct 2022 09:11:35 GMT"), class = c("insensitive", 
    ...
    date = structure(1665738695, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.2e-05, 
    connect = 2.2e-05, pretransfer = 7.7e-05, starttransfer = 0.031873, 
    total = 0.032031)), class = "response")
