structure(list(url = "https://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_zostera_m_pnt&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Mon, 04 Apr 2022 10:01:25 GMT"), class = c("insensitive", 
    ...
    date = structure(1649066485, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 5.5e-05, 
    connect = 5.5e-05, pretransfer = 0.00017, starttransfer = 0.039188, 
    total = 0.039575)), class = "response")
