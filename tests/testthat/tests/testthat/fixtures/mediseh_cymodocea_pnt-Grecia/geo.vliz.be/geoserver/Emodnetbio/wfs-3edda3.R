structure(list(url = "http://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_cymodocea_pnt&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Thu, 03 Mar 2022 07:32:48 GMT"), class = c("insensitive", 
    ...
    date = structure(1646292768, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 0.031362, 
    connect = 0.039437, pretransfer = 0.039488, starttransfer = 0.094817, 
    total = 0.094969)), class = "response")
