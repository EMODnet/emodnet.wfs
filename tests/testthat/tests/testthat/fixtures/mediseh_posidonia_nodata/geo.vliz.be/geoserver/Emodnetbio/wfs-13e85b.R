structure(list(url = "https://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_posidonia_nodata&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Mon, 04 Apr 2022 10:01:11 GMT"), class = c("insensitive", 
    ...
    date = structure(1649066471, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 5.4e-05, 
    connect = 5.4e-05, pretransfer = 0.000184, starttransfer = 0.081897, 
    total = 0.083214)), class = "response")
