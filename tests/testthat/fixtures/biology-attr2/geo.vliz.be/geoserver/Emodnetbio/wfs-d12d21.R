structure(list(url = "http://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_zostera_m_pnt&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Thu, 03 Mar 2022 07:07:48 GMT"), class = c("insensitive", 
    ...
    date = structure(1646291268, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.3e-05, 
    connect = 2.3e-05, pretransfer = 7.1e-05, starttransfer = 0.035642, 
    total = 0.035689)), class = "response")
