structure(list(url = "http://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_posidonia_nodata&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Mon, 14 Mar 2022 11:40:21 GMT"), class = c("insensitive", 
    ...
    date = structure(1647258021, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.7e-05, 
    connect = 2.7e-05, pretransfer = 7.2e-05, starttransfer = 0.095197, 
    total = 0.097516)), class = "response")
