structure(list(url = "http://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_posidonia_nodata&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Wed, 02 Mar 2022 15:07:42 GMT"), class = c("insensitive", 
    ...
    date = structure(1646233662, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.9e-05, 
    connect = 3e-05, pretransfer = 8.6e-05, starttransfer = 0.033911, 
    total = 0.033954)), class = "response")
