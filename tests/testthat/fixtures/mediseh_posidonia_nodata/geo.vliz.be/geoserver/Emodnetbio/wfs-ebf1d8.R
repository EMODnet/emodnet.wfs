structure(list(url = "https://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:OOPS_summaries&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Tue, 15 Mar 2022 06:59:17 GMT"), class = c("insensitive", 
    ...
    date = structure(1647327557, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 4.4e-05, 
    connect = 4.6e-05, pretransfer = 0.000144, starttransfer = 0.03603, 
    total = 0.036225)), class = "response")
