structure(list(url = "http://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_zostera_m_pnt&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Wed, 02 Mar 2022 16:02:57 GMT"), class = c("insensitive", 
    ...
    date = structure(1646236977, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.4e-05, 
    connect = 2.5e-05, pretransfer = 6.4e-05, starttransfer = 0.035035, 
    total = 0.035107)), class = "response")
