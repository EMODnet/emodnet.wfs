structure(list(url = "http://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_cymodocea_pnt&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Thu, 03 Mar 2022 06:58:47 GMT"), class = c("insensitive", 
    ...
    date = structure(1646290727, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 2.4e-05, 
    connect = 2.4e-05, pretransfer = 7.5e-05, starttransfer = 0.040057, 
    total = 0.040112)), class = "response")
