structure(list(url = "http://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_cymodocea_pnt&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Wed, 02 Mar 2022 16:02:48 GMT"), class = c("insensitive", 
    ...
    date = structure(1646236968, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 7.4e-05, 
    connect = 7.5e-05, pretransfer = 0.000125, starttransfer = 0.032527, 
    total = 0.032581)), class = "response")
