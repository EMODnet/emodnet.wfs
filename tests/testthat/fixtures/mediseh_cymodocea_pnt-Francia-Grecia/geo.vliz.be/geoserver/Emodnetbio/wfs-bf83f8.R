structure(list(url = "https://geo.vliz.be/geoserver/Emodnetbio/wfs?service=WFS&version=2.0.0&typeName=Emodnetbio:mediseh_posidonia_historical_shape&request=DescribeFeatureType", 
    status_code = 200L, headers = structure(list(server = "Apache-Coyote/1.1", 
        ...
        `transfer-encoding` = "chunked", date = "Tue, 15 Mar 2022 06:59:01 GMT"), class = c("insensitive", 
    ...
    date = structure(1647327541, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 4.1e-05, 
    connect = 4.2e-05, pretransfer = 0.000134, starttransfer = 0.034915, 
    total = 0.035071)), class = "response")
